...
scp build/android_like_fd_object_service_static root@"$TV_IP":"$SIDE_DIR/bin/android_like_fd_object_service"
scp build/android_like_fd_object_client_static root@"$TV_IP":"$SIDE_DIR/bin/android_like_fd_object_client"
