...
scp build/fd_bridge_service_static root@"$TV_IP":"$SIDE_DIR/bin/fd_bridge_service"
scp build/fd_bridge_client_static root@"$TV_IP":"$SIDE_DIR/bin/fd_bridge_client"

scp build/parcel_fd_lite_service_static root@"$TV_IP":"$SIDE_DIR/bin/parcel_fd_lite_service"
scp build/parcel_fd_lite_client_static root@"$TV_IP":"$SIDE_DIR/bin/parcel_fd_lite_client"

scp build/android_userspace_preflight_v1_static root@"$TV_IP":"$SIDE_DIR/bin/android_userspace_preflight_v1"
